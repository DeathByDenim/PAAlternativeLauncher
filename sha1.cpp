...
/* DeathByDenim says: I think I am allowed to use this, if I understand the
 * licence correctly. I added a static function at the end that calculates
 * the SHA1 of a file (calculateSHA1).
 */
